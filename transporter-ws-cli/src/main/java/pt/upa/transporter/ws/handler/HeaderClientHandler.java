 ...
 */
public class HeaderClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public static final String CLASS_NAME = HeaderClientHandler.class.getSimpleName();
